...
- обхода ограничений файловых систем и серверов хранения;

- повышения стабильности загрузки при сетевых передачах;

- унификации формата, используемого для гораздо более крупных моделей.

Однако при попытке интеграции MoICE это создало ряд нетривиальных проблем, напрямую связанных с несовместимостью между шардированными весами и модифицированным механизмом загрузки модели в `transformers`.
