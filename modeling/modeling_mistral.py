...
from transformers.modeling_outputs import BaseModelOutputWithPast, CausalLMOutputWithPast,MoeModelOutputWithPast, SequenceClassifierOutputWithPast,MoeCausalLMOutputWithPast
...
class MistralAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        raise RuntimeError("See MistralFlashAttention2")
...
class MistralFlashAttention2(MistralAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        query_states = apply_rotary_pos_emb_q(query_states,cos[:, position_ids[0],:],sin[:, position_ids[0], :],dim=-2) # 这里没有debug，要测一下
